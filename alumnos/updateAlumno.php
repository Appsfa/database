...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$insert_alumno = mysqli_query($link, "UPDATE Alumno set nombre =$nombre,apellidoPat=$apellidoP,apellidoMat=$apellidoM,semestre=$semestre ");
	
	if($insert_alumno)
	{
		$array['estado'] = "Alumno " . $matricula . " ACTUALIZADO";
	}
